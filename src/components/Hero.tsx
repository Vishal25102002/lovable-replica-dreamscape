    ...
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mb-12 animate-fade-in [animation-delay:0.2s]">
          <Card className="bg-white/10 backdrop-blur-xl border-white/20 shadow-glow p-6 max-w-2xl mx-auto">
            <div className="relative">
              <textarea
                className="w-full h-24 bg-white/5 border-white/20 rounded-lg px-4 py-3 text-white placeholder-white/60 resize-none focus:outline-none focus:ring-2 focus:ring-white/30"
